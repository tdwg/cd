...
1. [Introduction to Latimer Core documentation](#introduction-to-latimer-core-documentation)
    - [LtC Glossary](#ltc-glossary)
3. [Latimer Core standard and model concepts](#latimer-core-standard-and-model-concepts)
    - [Audiences](#audiences)
...
PLACEHOLDER: Remaining sections to be migrated start [~here in google draft-doc](https://docs.google.com/document/d/1b8H2aLayPLgq3NVMkyYNxix5sS1nl3m__JgvAEtfaYo/edit#heading=h.3itpizyt1k5h).
