...
A Latimer Core (LtC) record is a description of a group of natural science collection objects using the LtC vocabularies. The terms in this document can be loosely grouped into several categories.
